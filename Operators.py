...
def pmx(parent1,parent2):
    ...
    stop= random.randint(start,len(parent1)-1)
    child = [0]*len(parent1)
...
def ordercrossover(parent1,parent2):
    ...
    for i in range(stop+1,len(parent2)):
