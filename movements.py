...
filename = 'C:\\Users\\amundov\\Documents\\INF3490\\Assingments\\Innlevering 2\\assignment_2\\data\\movements_day1-3.dat'
...
# Run training:
net.earlystopping(train, train_targets, valid, valid_targets,iterations)
